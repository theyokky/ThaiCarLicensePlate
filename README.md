...
1.clone ตัวโปรเจค
2.เข้าไปที่โฟลเดอร์ของตัวโปรเจคเเล้วรันคำสั่ง pip install torch torchvision tensorflow imutils เพื่อติด library ที่จำเป็น
3.รันไฟล์ main.py ในโฟลเดอร์ program 
