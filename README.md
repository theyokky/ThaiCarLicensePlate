...
4.) นำวีดีโอของท่านใส่ไปในโฟล์เดอร์ input ที่อยู่ในโฟลเดอร์ program (หากท่านยังไม่มีวีดีโอ ทางเรามีวีดีโอตัวอย่างให้ภายในโฟลเดอร์ input แล้ว โดยวีดีโอจะมีชื่อว่า IMG_6374.mp4)

5.) รันโปรแกรมหลัก ด้วยคำสั่ง

     python main.py
     
6.) จากนั้น โปรแกรมจะรอรับคำสั่ง ให้ใส่ชื่อวีดีโอของท่าน เช่น IMG_6374.mp4
